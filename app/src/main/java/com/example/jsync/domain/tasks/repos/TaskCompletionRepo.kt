...
interface TaskCompletionRepo {
    suspend fun addTaskCompletion(taskCompletion: TaskCompletionDTO): Result<Boolean>
    suspend fun updateTaskCompletion(taskCompletion: TaskCompletionDTO): Result<Boolean>
